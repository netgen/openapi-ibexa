...
final class LocationSiblingsPathProvider implements PathProviderInterface
{
    ...
    public function providePaths(): iterable
    {
        ...
        $routePath = $this->router->getRouteCollection()->get('netgen_openapi_ibexa_location_siblings')?->getPath() ?? '';
